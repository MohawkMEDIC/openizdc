...
Build-Depends: debhelper (>=9), libwebkit1.1-cil , ca-certificates-mono (>=4), libmono-2.0-1 (>=4), libmono-cil-dev (>=4), mono-4.0-gac (>=4), mono-4.0-service (>=4), mono-jay (>=4), mono-runtime (>=4), mono-runtime-sgen (>=4), mono-utils (>=4), gtk-sharp3 (>=2), mono-devel (>=4)
...
Section: contrib/other
Priority: optional
Depends: libwebkit1.1-cil, ca-certificates-mono (>=4), libmono-2.0-1 (>=4), libmono-cil-dev (>=4), mono-4.0-gac (>=4), mono-4.0-service (>=4), mono-jay (>=4), mono-runtime (>=4), mono-runtime-sgen (>=4), mono-utils (>=4), gtk-sharp3 (>=2), mono-devel (>=4)
Homepage: http://openiz.org
Architecture: any
